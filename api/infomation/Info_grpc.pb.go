...
const (
	Info_CreateInfo_FullMethodName = "/api.infomation.Info/CreateInfo"
	Info_UpdateInfo_FullMethodName = "/api.infomation.Info/UpdateInfo"
	Info_DeleteInfo_FullMethodName = "/api.infomation.Info/DeleteInfo"
	Info_GetInfo_FullMethodName    = "/api.infomation.Info/GetInfo"
	Info_ListInfo_FullMethodName   = "/api.infomation.Info/ListInfo"
)
...
func (c *infoClient) CreateInfo(ctx context.Context, in *CreateInfoRequest, opts ...grpc.CallOption) (*CreateInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Info_CreateInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infoClient) UpdateInfo(ctx context.Context, in *UpdateInfoRequest, opts ...grpc.CallOption) (*UpdateInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Info_UpdateInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infoClient) DeleteInfo(ctx context.Context, in *DeleteInfoRequest, opts ...grpc.CallOption) (*DeleteInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Info_DeleteInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infoClient) ListInfo(ctx context.Context, in *ListInfoRequest, opts ...grpc.CallOption) (*ListInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Info_ListInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Info_CreateInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Info_CreateInfo_FullMethodName,
	}
...
func _Info_UpdateInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Info_UpdateInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Info_DeleteInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Info_DeleteInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Info_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.infomation.Info",
	...
	Metadata: "api/infomation/Info.proto",
}
